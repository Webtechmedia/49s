		...
		if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
			...
			if($image_res){
				...
				if($this->normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size, $image_width, $image_height, $jpeg_quality))
				{
					...
					echo '<input type="hidden" name="image_path" value="uploads/'.$thumb_prefix . $new_file_name.'"/>';
					echo '<input type="hidden" name="admin_image_path" value="./../../../uploads/'.$thumb_prefix . $new_file_name.'"/>';
					echo '<img src="./../../../uploads/'.$thumb_prefix . $new_file_name.'" class="img-thumbnail" />';
