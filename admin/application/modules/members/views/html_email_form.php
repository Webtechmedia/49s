						 ...
						 <table class="table table-striped table-bordered table-condensed table-hover" id="template-table">
							...
							<?php foreach($templates as $template){?>
								<tr>
									...
									<td>
										<a class="btn btn-success btn-xs" href="javascript:;" onclick="loadHtmlEmailContent(<?php echo $template->id;?>);return false;"><span class="fa fa-arrow-up"></span> Load Template</a>
									</td>
									<td>
