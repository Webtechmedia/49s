            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title"> <?php echo form_submit('add', 'Save New Presenter','class="btn btn-success pull-right " form="mainform"'); ?></h3>
                    ...
                    <div class="panel-body">
                       	<fieldset>
							<?php echo form_open('presenters/insertNewpresenter',array('id'=>'mainform','form'=>'mainform','name'=>'mainform'));?>
							...
							<div class="row form-group">
								<div class="col-md-3">
									...
									<div id="output">
										<img name="temp_img" id="temp_img" src="<?php echo ( ($this->session->userdata('image_upload_temp_pr') != '') ? base_url($this->session->userdata('image_upload_temp_pr')) : "") ?>" class="img-thumbnail" />
									</div>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-3">
									...
									<div id="output">
										<img name="temp_img2" id="temp_img2" src="<?php echo ( ($this->session->userdata('image_upload_temp_pr2') != '') ? base_url($this->session->userdata('image_upload_temp_pr2')) : "") ?>" class="img-thumbnail" />
									</div>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-3">
									...
									<video id="temp_video" width="320" height="240"  controls>
										<source id="video_src" src="<?php echo ( ($this->session->userdata('video_upload_temp_pr') != '') ? base_url($this->session->userdata('video_upload_temp_pr')) : "") ?>" type="video/mp4">
							...
							<div class="form-group">
								...
								<input type="text" name="title" id="title" value="<?php echo set_value('title'); ?>" class="form-control" placeholder="Title" >
								<div class="alert-danger"><?php echo form_error('title'); ?></div>
							</div>

							<div class="form-group">
								<?php echo form_label('Caption'); ?>
								<input type="text" name="caption" id="title" value="<?php echo set_value('caption'); ?>" class="form-control" placeholder="Caption" >
								<div class="alert-danger"><?php echo form_error('title'); ?></div>
							</div>
							<div class="form-group">
								<script>
