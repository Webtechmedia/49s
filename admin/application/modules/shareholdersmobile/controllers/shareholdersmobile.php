...
class Shareholdersmobile extends CI_Controller
{
	...
	function index()
	{
		...
		$data['title'] = 'Shareholders mobile';
		...
		$this->template->write_view('content', 'shareholdersmobile/content',$data);
	...
	function change($id = 0)
	{
		...
		$this->template->write_view('head', 'common/head',$data);
		$this->template->write_view('header', 'common/header',$data);
		$this->template->write_view('content', 'shareholdersmobile/add_edit',$data);
		$this->template->write_view('footer', 'common/footer',$data);
	...
	function remove_content($id){
		...
		$this->db->where('id',$id);
		$this->db->delete('t_shareholders_mobile');
		redirect(base_url('shareholdersmobile'));
