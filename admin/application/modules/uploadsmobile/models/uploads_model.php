...
class Uploads_model extends CI_Model {
    ...
    var $allow_rec_number_home = 3;
    var $allow_rec_number_oracle = 3;
    var $allow_rec_number_Bet = 3;
    var $allow_rec_number_Responsible = 3;

    var $allow_rec_number_49s_Last = 3;
    var $allow_rec_number_49s_Prev = 3;
    var $allow_rec_number_49s_H_C = 3;
    var $allow_rec_number_49s_Lucky_Dip = 3;
    var $allow_rec_number_49s_syndicates = 3;
    var $allow_rec_number_49s_winner = 3;
    var $allow_rec_number_49s_How_to_Play = 3;
    var $allow_rec_number_49s_Rule = 3;

    var $allow_rec_number_ILB_Last = 3;
    var $allow_rec_number_ILB_prev_results = 3;
    var $allow_rec_number_ILB_H_C = 3;
    var $allow_rec_number_ILB_Lucky_Dip = 3;
    var $allow_rec_number_ILB_syndicates = 3;
    var $allow_rec_number_ILB_How_to_Play = 3;
    var $allow_rec_number_ILB_Rule = 3;

    var $allow_rec_number_VHR_Last = 3;
    var $allow_rec_number_VHR_prev = 3;
    var $allow_rec_number_VHR_How_to_Play = 3;
    var $allow_rec_number_VHR_Rule = 3;

    var $allow_rec_number_VGR_Last = 3;
    var $allow_rec_number_VGR_prev = 3;
    var $allow_rec_number_VGR_How_to_Play = 3;
    var $allow_rec_number_VGR_Rule = 3;

    var $allow_rec_number_Rapido_Last = 3;
    var $allow_rec_number_Rapido_prev = 3;
    var $allow_rec_number_Rapido_How_to_Play = 3;
    var $allow_rec_number_Rapido_Rule = 3;
    ...
    var $allow_rec_number_is_how_to_play_bgr_49s = 3;
    var $allow_rec_number_is_lucky_dip_bgr_49s = 3;
    var $allow_rec_number_is_how_to_play_bgr_ilb = 3;
    var $allow_rec_number_is_lucky_dip_bgr_ilb = 3;
    var $allow_rec_number_is_how_to_play_bgr_ra = 3;
    var $allow_rec_number_is_lucky_dip_bgr_ra = 3;
    var $allow_rec_number_is_how_to_play_bgr_vhr = 3;
    var $allow_rec_number_is_lucky_dip_bgr_vhr = 3;
    var $allow_rec_number_is_how_to_play_bgr_vgr = 3;
    var $allow_rec_number_is_lucky_dip_bgr_vgr = 3;
    ...
    function is_reach_limit($type,$check_video = false){
        ...
        if($type == 'is_promo_vdr_have'){
            ...
            $limit = $this->allow_rec_number_promo_vdr_have;
            $limit_video = $this->allow_rec_number_promo_vdr_have_video;
        }
    ...
    function save_in_db($type,$url,$overlay_text,$id){
        ...
        if($id == 0){
            $this->db->insert('t_uploads_mobile');
            return $this->db->insert_id();
        } else {
            $this->db->where('id',$id);
            $this->db->update('t_uploads_mobile');
            return $id;
        }
    ...
    public function getUpload($id){
        $this->db->where('id',$id);
        $query = $this->db->get('t_uploads_mobile');
